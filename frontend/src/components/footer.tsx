  ...
  return (
    <footer className="bg-background border-t border-border mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              {/* ✅ FIXED: Changed from /contact to /#contact to scroll to contact section */}
              <li><Link href="/#contact" className="hover:text-orange-500 transition-colors">Contact Support</Link></li>
            </ul>
          </div>

          {/* ✅ PAYSTACK REQUIRED: Legal & Policies */}
          <div>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <a href="mailto:support@ewalogistics.com" className="p-2 bg-muted rounded-full hover:bg-orange-500 hover:text-white transition-colors text-muted-foreground">
                <Mail className="w-4 h-4" />
              </a>
              <a href="tel:+2348000000000" className="p-2 bg-muted rounded-full hover:bg-orange-500 hover:text-white transition-colors text-muted-foreground">
        ...
        {/* ✅ EXACT COPYRIGHT TEXT AS REQUESTED */}
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted-foreground text-center md:text-left">
          <p>© 2026 EWA Logistics Limited. All rights reserved. | Abuja, Nigeria | RC: 9608218</p>
          <div className="flex gap-6">
            ...
            <Link href="/policies/earnings" className="hover:text-orange-500 transition-colors">Earnings Policy</Link>
          </div>
        </div>
      </div>
    </footer>
